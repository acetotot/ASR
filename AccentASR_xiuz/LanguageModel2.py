...
class ModelLanguage(): # 语音模型类
	...
	def LoadModel(self):
		self.dict_pinyin = self.GetSymbolDict("/data2/lzl/project/speechz/dict.txt")
...
if(__name__=='__main__'):
	...
	ml = ModelLanguage("/data2/lzl/project/speechz/model_language")
	ml.LoadModel()
	...
	str_pinyin = ['zhang1', 'zhang3', 'shi4', 'ge4', 'sha3', 'zi3']
